...
#Loop through all possible values of a paramter
#each loop plots the same plot
#thus can compare different sections of data


#Vari = 'R0c1'

for Vari in [ 'eta bar', 'R0c1', 'R0c2', 'R0c3', 'nfps']:  #InputDict.keys():
